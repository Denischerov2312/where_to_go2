...
- Затем используйте pip (или pip3, есть конфликт с Python2) для установки зависимостей:
 ...
 - Настройте виртуальное окружение. Создайте файл `.env` в корневой папке проекта. Минимальные данные, которые нужны для запуска:
  ...
  ```
- Примените все миграции командой `python manage.py migrate`

- Командой `python manage.py load_places` загрузить данные для карты, иначе она будет пустая. Так можете сами создать json файл. Пример такого файла ниже.
